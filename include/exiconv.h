...
* @Last Modified time: 2015-11-04 19:47:23
*/
...
/**
 * @brief 将UCS4的字符串转换为utf8编码，便于输出
 * 
 * @param data UCS4格式的字符串数组
...
/**
 * @brief 将utf8编码转换为内部UCS4格式
 * 
 * @param data C风格字符串数组
 * @param outsize 转换后的UCS4字符串长度
 * 
 * @return 转换后的字符串，会自动新malloc空间，用过后由调用者释放
 */
extern echar_t*
...
/**
 * @brief 自动读取文件下的文本内容，识别文本编码，并自动转换位为UCS4的内部编码格式
 * 
 * @param f 文件指针，读模式打开
